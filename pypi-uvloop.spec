...
Source0  : https://files.pythonhosted.org/packages/9c/16/728cc5dde368e6eddb299c5aec4d10eaf25335a5af04e8c0abd68e2e9d32/uvloop-0.19.0.tar.gz
...
%prep
%setup -q -n uvloop-0.19.0
cd %{_builddir}/uvloop-0.19.0
pushd ..
cp -a uvloop-0.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698019919
