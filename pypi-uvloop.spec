...
Source0  : https://files.pythonhosted.org/packages/80/f9/94d2d914d351c7d5db80e102fb0d7ab3bbb798e8322ab71a9fe9f8bfa31b/uvloop-0.18.0.tar.gz
...
%prep
%setup -q -n uvloop-0.18.0
cd %{_builddir}/uvloop-0.18.0
pushd ..
cp -a uvloop-0.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697335033
